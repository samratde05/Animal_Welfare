...
const MyPets = ({ profile }) => {
  const [menuText, setMenuText] = useState("adopted");
    ...
    <section className="my-pets">
      <aside className="flex-wrap">
        <div className="flex-col--w">
          <h3
            className={menuText === "adopted" ? "my-pets__heading" : "hidden"}
          >
            You have {profile ? profile.adoptedPets.length : "some"} pet(s)
            adopted
          </h3>
        ...
        <div className="flex-col-3">
          ...
          <p className="my-pets__quote">
            ...
            unawakened.” <br></br> –Anatole France.
          </p>
        </div>
      </aside>
    </section>
